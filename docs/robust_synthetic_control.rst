...
* **Algorithm:** denoise the data matrix using singular value thresholding, then apply standard SCM to the denoised data.
* **Advantages:** less sensitive to noise, improved donor unit selection, and works well with missing data.
